...
export default function EditExerciseScreen() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      return services.firestore.getExercise(user.uid, id);
    },
    enabled: !!user?.uid && !!id,
  });
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await services.firestore.updateExercise(user.uid, id, {
        name: name.trim(),
      ...
      showSuccess(t('exercise.exerciseUpdatedSuccessfully') || 'Exercise updated successfully!');
